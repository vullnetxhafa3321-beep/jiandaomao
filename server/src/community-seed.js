...
const FORUM_SEED = [
  { title: '朝阳大悦城附近发现一只橘猫', content: '在小区门口车棚下面看到的，大概3个月大，很瘦，看起来饿了好几天', address: '朝阳大悦城附近', lat: 39.92, lng: 116.475, status: 'found', user_name: '小文', created_at: '2026-07-09T14:30:00' },
  { title: '海淀黄庄地铁站B口 小黑狗', content: '黑色小土狗，脖子上有旧的红色项圈，可能是走失的。很亲人', address: '海淀黄庄地铁站B口', lat: 39.9766, lng: 116.319, status: 'found', user_name: '宠物达人小王', created_at: '2026-07-09T10:15:00' },
  { title: '通州万达旁边的花猫 已经带去医院了', content: '打了疫苗做了驱虫，医生说大概半岁，母猫。现在在我家隔离中', address: '通州万达广场', lat: 39.8912, lng: 116.6622, status: 'rescued', user_name: '爱猫的小李', created_at: '2026-07-08T18:00:00' },
  { title: '房山良乡发现一窝小猫 求助', content: '一共4只，眼睛刚睁开，在纸箱里被人丢在垃圾桶旁边', address: '房山区良乡镇', lat: 39.7352, lng: 116.1317, status: 'found', user_name: '学生救助', created_at: '2026-07-08T09:30:00' },
  { title: '西直门立交桥下白色猫咪', content: '白色长毛猫，蓝眼睛，很漂亮，不像是流浪猫', address: '西直门立交桥', lat: 39.94, lng: 116.353, status: 'found', user_name: '路过的好心人', created_at: '2026-07-07T16:00:00' },
  { title: '已成功救助！感谢大家', content: '之前发的那只橘猫已经被救助站接收了，谢谢各位！', address: '朝阳区', lat: 39.92, lng: 116.462, status: 'adopted', user_name: '小文', created_at: '2026-07-07T12:00:00' },
];
...
export function seedCommunity() {
  ...
  FORUM_SEED.forEach((p) => {
    insertForum.run(uuid(), p.user_name, p.title, p.content, p.address, p.lat, p.lng, p.status, p.created_at);
  });
