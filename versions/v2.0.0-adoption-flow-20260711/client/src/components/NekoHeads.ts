...
/** Shelter: heart-home PNG from design asset */
function shelterPinHtml() {
  const common =
    'width:44px;height:44px;border-radius:50%;display:flex;align-items:center;justify-content:center;border:3px solid #fff;box-shadow:0 2px 8px rgba(92,64,51,0.28);box-sizing:border-box;overflow:hidden;padding:3px;';
