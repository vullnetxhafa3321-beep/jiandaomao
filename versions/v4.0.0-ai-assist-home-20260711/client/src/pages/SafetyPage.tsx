...
export default function SafetyPage() {
  ...
  const takeHomeTips = [
    '无论家中是否已有宠物：先安置在安静独立房间，提供躲藏处（航空箱/纸箱）',
    '立刻检查封窗封阳台，防止应激逃窜；24 小时内预约体检 + 驱虫，不要急于洗澡',
    '若已有其他宠物：隔离 7–14 天，独立食盆、水碗、猫砂盆；先通过门缝交换气味再短时间见面',
    '确认双方疫苗、驱虫完成后再逐步接触；有狗时先给猫高处躲避空间，切勿强行凑近',
    ...
    <Layout className="pb-8">
      ...
      <div className="px-5 space-y-4">
        ...
        <div className="frog-card-wood p-4">
          <h3 className="font-bold text-[var(--frog-ink)] mb-2">🏠 临时带回家</h3>
